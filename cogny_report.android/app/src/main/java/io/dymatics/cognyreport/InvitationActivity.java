...
public class InvitationActivity extends AppCompatActivity {
                    ...
                    if (task.isSuccessful()) {
                        restClient.signin(task.getResult().getToken(), new On<User>()
                                .addSuccessListener(result -> {
                                    cognyBean.saveUser(result, new On<User>().addSuccessListener(u -> startMainActivity()));
                                })
    ...
    @UiThread
    void startSignInvitationActivity(User.Invitation invitation) {
                ...
                .addOnSuccessListener(this, pendingDynamicLinkData -> {
                    ...
                    if (code != null && !code.isEmpty()) {
                        restClient.checkInvite(code, new On<User.Invitation>().addSuccessListener(invitation -> {
                            ...
                            startSignInvitationActivity(invitation);
