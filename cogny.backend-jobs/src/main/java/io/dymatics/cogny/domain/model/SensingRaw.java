...
//            log.info("key: " + sensingRawEntity.getKey().getName());
    ...
    @Data
    @AllArgsConstructor
    public static class DatastoreObject implements Serializable {
        private static final long serialVersionUID = -245855367857919486L;
    ...
    @Data
    @AllArgsConstructor
    public static class DatastoreResult implements Serializable {
        private static final long serialVersionUID = 6544396457264212489L;

        private String startCursorString;
        private List<DatastoreObject> list;

        public DatastoreResult(List<DatastoreObject> list) {
            this.list = list;
        }
    }
}
